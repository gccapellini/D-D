/* ═══════════════════════════════════════════════════════
   SCENE3.JS — Chapter III VTT-style map viewer
   Same engine as scene.js (Chapter II), duplicated so this
   dungeon's floors/characters/sync data stay fully separate
   from Chapter II's. See scene.js for the full commentary
   on how the sync/master-roster/resize mechanics work.
═══════════════════════════════════════════════════════ */
...
// without the data mixing together. Chapter III gets its own
// table so its tokens never collide with Chapter II's.
const TABLE_ID = 'chapter3-table';
...
───────────────────────────────────────────────────────── */
const FLOORS = [
  { id: 1, name: "Mapa 1", img: "Chap3Img1.jpeg", unlocked: true },
  { id: 2, name: "Mapa 2", img: "Chap3Img2.jpeg", unlocked: true },
];
...
const ENEMIES = [
  { id: "mercenario", name: "Mercenário", img: "token_mercenario.png", color: "#5a4a3a" },
  { id: "mago",       name: "Mago",       img: "token_mago.png",       color: "#4a3a7a" },
  { id: "capitao",    name: "Capitão",    img: "token_capitao.png",    color: "#7a1f1f" },
];
